...
typedef void (*ilG_material_onBindFunc)(ilG_material *self, GLint uniform, void *user);
typedef void (*ilG_material_onPosFunc)(ilG_material *self, il_positionable *pos, GLint uniform, void *user);
